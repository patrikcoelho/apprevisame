  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-3">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold text-[#1f1c18]">
            Registro diário de novos assuntos.
          </h1>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-4 rounded-lg border border-[#e6dbc9] bg-[#fffaf2] p-6">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="relative max-w-md">
                <button
                  type="button"
                  className="flex h-11 w-full items-center justify-between rounded-md border border-[#e2d6c4] bg-white px-3 text-sm text-[#1f1c18]"
                      ...
                      {subjects.length === 0 ? (
                        ...
                        subjects.map((item) => (
                          <button
                            key={item.id}
                            type="button"
                            className="flex w-full items-center justify-between px-3 py-2 text-left text-sm text-[#1f1c18] hover:bg-[#f6efe4]"
                            onClick={() => {
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                className="h-11 w-full max-w-md rounded-md border border-[#e2d6c4] bg-white px-3 text-sm text-[#1f1c18]"
          ...
          <div className="space-y-2">
            ...
            <textarea
              className="min-h-[96px] w-full max-w-xl rounded-md border border-[#e2d6c4] bg-white px-3 py-2 text-sm text-[#1f1c18]"
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <input
                    type="number"
                    min={1}
                    className="h-11 w-full max-w-[220px] rounded-md border border-[#e2d6c4] bg-white px-3 text-sm text-[#1f1c18]"
          ...
          <button
            type="button"
            className="w-full rounded-md bg-[#1f5b4b] px-5 py-3 text-sm font-semibold text-[#fffaf2] disabled:cursor-not-allowed disabled:bg-[#9fbfb5]"
        ...
        <aside className="space-y-4 rounded-lg border border-[#e6dbc9] bg-[#fffaf2] p-6">
          <div>
            <p className="text-xs font-semibold uppercase text-[#6b6357]">
              Prévia de revisões
            </p>
